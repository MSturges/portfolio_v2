...
const SkillsSection = () => {
  ...
  return (
    ...
    <div className="skills-break"></div>
    <div className="skills-break-head"><h2><span className="fa fa-cogs"></span>Technologies & Skills</h2></div>

    <div className="skills-container">
    <div className="devicons devicons-custom devicons-white devicons devicons devicons-terminal"><div className="devicons-text">Terminal</div></div>
    <div className="devicons devicons-custom devicons-green devicons devicons-atom"><div className="devicons-text">Atom</div></div>
    <div className="devicons devicons-custom devicons-green devicons-github_badge"><div className="devicons-text">Git Hub</div></div>
    <div className="devicons devicons-custom devicons devicons-rust devicons devicons-html5"><div className="devicons-text">HTML</div></div>
    <div className="devicons devicons-custom devicons-blue devicons devicons-css3"><div className="devicons-text">CSS</div></div>
    <div className="devicons devicons-custom devicons-pink devicons devicons-sass"><div className="devicons-text">Sass</div></div>
    <div className="devicons devicons-custom devicons-rust devicons devicons-bower"><div className="devicons-text">Bower</div></div>
    <div className="devicons devicons-custom devicons-purple devicons-purple devicons devicons-bootstrap"><div className="devicons-text">Boot Strap</div></div>
    ...
    <div className="devicons devicons-custom devicons devicons-white devicons-nodejs_small"><div className="devicons-text">Node.js/Express</div></div>
